...
public final class ActivityChatBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout chatshome;

  @NonNull
  public final RecyclerView recyclerView;

  private ActivityChatBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout chatshome,
  ...
  public static ActivityChatBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      LinearLayout chatshome = (LinearLayout) rootView;
      ...
      return new ActivityChatBinding((LinearLayout) rootView, chatshome, recyclerView);
    }
